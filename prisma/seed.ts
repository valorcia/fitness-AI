...
const COACHES = [
  {
    slug: "alex",
    displayName: "Alex Morel",
    gender: "male",
    ageYears: 34,
    ethnicity: "european",
    specialty: "Musculation & force",
    style: "MILITARY",
    bio: "Ancien préparateur physique équipe de France d'athlétisme. 15 ans d'expérience, spécialisé force et hypertrophie.",
    tagline: "Je ne fais pas de compromis. Tu vas progresser.",
    portraitUrl: U("photo-1544005313-94ddf0286df2"),
    bodyUrl: U("photo-1605296867304-46d5465a13f1"),
  ...
  {
    slug: "lea",
    displayName: "Léa Chen",
    gender: "female",
    ageYears: 29,
    ethnicity: "asian",
    specialty: "Cardio & endurance",
    style: "FRIENDLY",
    bio: "Marathonienne et coach endurance. J'aime faire découvrir la course à tous les niveaux avec bienveillance.",
    tagline: "On avance à ton rythme, mais on avance.",
    portraitUrl: U("photo-1438761681033-6461ffad8d80"),
    bodyUrl: U("photo-1571019613454-1cb2f99b2d8b"),
  ...
  {
    slug: "marcus",
    displayName: "Marcus Diallo",
    gender: "male",
    ageYears: 41,
    ethnicity: "african",
    specialty: "Crossfit & conditioning",
    style: "EXPERT",
    bio: "Coach Crossfit Level 3. J'explique le pourquoi derrière chaque mouvement. Science + intensité.",
    tagline: "Comprendre, c'est déjà progresser.",
    portraitUrl: U("photo-1568602471122-7832951cc4c5"),
  ...
  },
  {
    ...
    ageYears: 37,
    ethnicity: "european",
    specialty: "Perte de poids & nutrition",
    style: "FRIENDLY",
    bio: "Diététicienne-nutritionniste et coach. Approche holistique, sans culpabilité, avec résultats durables.",
    tagline: "Ton corps te parle. Apprenons à l'écouter.",
    portraitUrl: U("photo-1531746020798-e6953c6e8e04"),
  ...
  {
    slug: "sam",
    displayName: "Sam Jensen",
    gender: "neutral",
    ageYears: 32,
    ethnicity: "mixed",
    specialty: "Remise en forme",
    style: "FRIENDLY",
    bio: "Coach santé mentale et physique. Convaincu·e que le sport commence par un pas.",
    tagline: "Un jour à la fois, et on fait équipe.",
    portraitUrl: U("photo-1534528741775-53994a69daeb"),
  ...
  {
    slug: "kenji",
    displayName: "Kenji Takeda",
    gender: "male",
    ageYears: 45,
    ethnicity: "asian",
    specialty: "Mobilité & récupération",
    style: "EXPERT",
    bio: "Kinésithérapeute du sport, expert mobilité et prévention des blessures. Calme, précis, pédagogue.",
    tagline: "La longévité sportive, c'est l'affaire d'un bon geste.",
    portraitUrl: U("photo-1506794778202-cad84cf45f1d"),
  ...
  {
    slug: "nora",
    displayName: "Nora Haddad",
    gender: "female",
    ageYears: 31,
    ethnicity: "maghrebi",
    specialty: "Running & trail",
    style: "MILITARY",
    bio: "Ultra-traileuse et coach running. J'emmène les marathoniens au-delà de leurs limites.",
    tagline: "Le corps écoute quand la tête décide.",
    portraitUrl: U("photo-1517841905240-472988babdf9"),
  ...
  },
  {
    ...
    specialty: "Longévité & bien-être",
    style: "EXPERT",
    bio: "Coach longévité & force après 40 ans. Approche scientifique pour rester performant·e toute sa vie.",
    tagline: "On construit ton corps de demain.",
    portraitUrl: U("photo-1580489944761-15a19d654956"),
    elevenLabsVoiceId: "oWAxZoI1aAwrhHvPlQ1h",
    openaiVoice: "nova",
    locales: ["fr", "en"],
    isPremium: true,
  },
...
async function main() {
  ...
  for (const c of COACHES) {
    await prisma.coachProfile.upsert({ where: { slug: c.slug }, update: c, create: c });
  }
  ...
  console.log(
    `Seed complete — ${EXERCISES.length} exercises, ${BADGES.length} badges, ${COACHES.length} coaches.`,
  );
}
